/**
 * Sklapanje natalne karte.
 *
 * Odvojeno od ephemeris.ts zato sto taj uvozi WASM kao modul - sto radi samo u
 * Workers-u. Ovde nema nijednog takvog uvoza, pa se sve odavde testira obicnim Node-om.
 *
 * Povod za razdvajanje: `norm` je pri ranijem preuredjivanju ostao koriscen a neuvezen.
 * Isporuka je prosla, tipovi nisu provereni, a /v1/chart je pukao UZIVO - jer su testovi
 * proveravali sirove pozive swisseph-a umesto ove funkcije.
 */
